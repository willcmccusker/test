<footer class='footer'> 
	<div class='grid wide'>
		<div class='col-1-3 tab-1-1 mob-1-1'>
		...
		<div class='col-2-3 tab-1-1 mob-1-1'>
			<img onload="setFooter();" class='lazyimg' src='/file-manager/userfiles/logos/logo_block.png' alt="logo_block" width="500px" />
			<ul>
