					...
					<div class="panel-heading"><?php echo __('Actions'); ?></div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
									<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-edit"></span>&nbsp&nbsp;Edit World'), array('action' => 'edit', $world['World']['id']), array('escape' => false)); ?> </li>
		<li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Delete World'), array('action' => 'delete', $world['World']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $world['World']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp&nbsp;List Worlds'), array('action' => 'index'), array('escape' => false)); ?> </li>
		<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp&nbsp;New World'), array('action' => 'add'), array('escape' => false)); ?> </li>
...
<div class="related row">
	...
	<thead>
	<tbody>
	<?php foreach ($world['City'] as $city): ?>
		<tr>
