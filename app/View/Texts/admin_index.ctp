				...
				<?php foreach ($texts as $text): ?>
					<tr>
						...
						<td class="actions">
							...
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $text['Text']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $text['Text']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $text['Text']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
