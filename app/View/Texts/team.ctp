    ...
    $team = array(
        ...
        array(
            ...
            "info"=>" es becario académico en el Programa de Expansión Urbana del Instituto Marron de Gerencia Urbana y la Escuela de Negocios Stern de la Universidad de Nueva York. Nicolás tiene un maestría en Planeación Urbana en la Escuela Robert F. Wagner de Servicio Público de la misma Universidad. Sirvió como asesor del Director de la Estrategia de Superación de Pobreza Extrema y del Alto Consejero Presidencial para la Acción Social y la Cooperación Internacional en temas de Tecnología Cívica e Innovación. También fue pasante en el Parlamento Alemán en Berlín y asistente de investigación de las Facultades Ciencia Política y Relaciones Internacionales de la Universidad del Rosario en Bogotá. Actualmente coordina la implementación de diferentes iniciativas de crecimiento ordenado en Latinoamérica y realiza investigación sobre crecimiento urbano y sobre el estado del crecimiento de las ciudades en el mundo."
            ),
        array(
        ...
        array(
            ...
            "info"=>" es Jefe de Análisis de Imágenes de Observatorio Indio de Expansión Urbana (UXO-INDIA), un centro de investigación iniciado en colaboración con el Proyecto de Urbanización de la Universidad de Nueva York (Escuela de Negocios Stern) y la Sociedad de Educación Mahatma (MES) de New Panvel, India. Tiene una Maestría en Geoinformática de la facultad de Ciencias de la Geo-Información y Observación de la Tierra de la Universidad de Twente - ITC, Holanda. Recibió la beca Erasmus Mundus de la Unión Europea para cursar su maestría en Geoinformática en ITC. Los intereses de investigación de Sharad incluyen trabajo con sensores remotos satelitales, el procesamiento de imágenes, los Sistema de Información Geográfica (SIG), la modelación espacial, la geoestadística clásica y avanzada (estadística espacial), la cartografía de alta resolución basada en drones y modelación 3D."
            )
        );
    ?>
