    ...
    $team = array(
        ...
        array(
            "img"=>"http://atlasofurbanexpansion.org/file-manager/userfiles/About/Achilles_300px.jpg",
            "name"=>"Achilles Kallergis",
