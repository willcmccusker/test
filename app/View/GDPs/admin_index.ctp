<div class="gDPs index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('G D Ps'); ?></h1>
			</div>
		</div><!-- end col md 12 -->
	</div><!-- end row -->
	...
	<div class="row">
					...
					<div class="panel-heading"><?php echo __('Actions'); ?></div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><?php echo $this->Html->link('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;'.__('New G D P'), array('action' => 'add'), array('escape' => false)); ?></li>
		...
		<div class="col-md-9">
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<tbody>
				<?php foreach ($gDPs as $gDP): ?>
					<tr>
						<td nowrap><?php echo h($gDP['GDP']['id']); ?>&nbsp;</td>
						<td nowrap><?php echo h($gDP['GDP']['name']); ?>&nbsp;</td>
						<td nowrap><?php echo h($gDP['GDP']['slug']); ?>&nbsp;</td>
								<td>
			<?php echo $this->Html->link($gDP['DataSet']['id'], array('controller' => 'data_sets', 'action' => 'view', $gDP['DataSet']['id'])); ?>
		</td>
						<td nowrap><?php echo h($gDP['GDP']['city_count']); ?>&nbsp;</td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $gDP['GDP']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $gDP['GDP']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $gDP['GDP']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $gDP['GDP']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
