<div class="gDPs form">
<?php echo $this->Form->create('GDP'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit G D P'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('GDP.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('GDP.id')))); ?></li>
